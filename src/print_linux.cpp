...
static void draw_print_page(GtkPrintOperation*, GtkPrintContext* context, gint, gpointer userdata) {
    ...
    cairo_surface_t* surface = cairo_image_surface_create_for_data(
        reinterpret_cast<unsigned char*>(image.pixels.data()), CAIRO_FORMAT_RGB24,
...
bool print_image(const Image& source) {
    ...
    GtkPrintOperationResult result = gtk_print_operation_run(operation, GTK_PRINT_OPERATION_ACTION_PRINT_DIALOG,
                                                           nullptr, nullptr);
